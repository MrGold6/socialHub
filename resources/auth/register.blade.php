            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('register') }}" class="form-box px-3" >
                    <div class="form-input">
                        ...
                        <input type="text" name="middleName" placeholder="Ім'я" required>
                    </div>
                    <div class="form-input">
                        <span><i class="fa fa-user"></i></span>
                    ...
                    <div class="form-input">
                        <span><i class="fa fa-user"></i></span>
                        <input type="text" name="lastName" placeholder="По-батькові" required>
                    </div>
                    <div class="form-input">
                    ...
                    <div class="mb-3">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="cb2" name="">
